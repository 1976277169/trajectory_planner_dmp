...
namespace MotionControl
{
	...
	float amp_x,amp_y, amp_z, omega_x, omega_y,omega_z;
        bool periodic_active,kinestetic_active,calibration_active,circle_active,trajectory_from_file;
	std::vector<KDL::Frame> whole_trajectory;
	std::vector<std::vector<float> > whole_file;
	double x0,y0,z0,a0,b0,c0;
	double a_begin,b_begin,c_begin,x_begin,y_begin,z_begin;
